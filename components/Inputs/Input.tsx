	...
	return (
		<div className="w-full relative">
			<input
				...
				placeholder=" "
				type={type}
				className={`text-neutral-800 peer w-full p-3 pt-6 pl-4 font-light bg-neutral-400/20 border-2 border-neutral-400/75 rounded-md outline-none transition disabled:opacity-70 disabled:cursor-not-allowed relative
        ...
        `}
            ...
            ${errors[id] ? "text-rose-300 font-semibold" : "text-zinc-500"}
        `}
			>
				{label}
			</label>
